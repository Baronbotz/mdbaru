...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/cJG2gC1S/20220612-221836.jpg' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support we appreciate you we dont need your money, support us by subscribing to our youtube channel* *DRIPS OFC:* https://www.youtube.com` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
...
┃ 
┃      
┃http://www.instagram.com/baron_store01
┃
┃━━━━━━━━━━━━━━━━━━┃
┃                  B A R O N BOTZ
╰━━━━━━━━━━━━━━━━━━╯`,
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://www.youtube.com` } }, { urlButton: { displayText: `GITHUB`, url : `http://www.instagram.com/baron_store01` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
